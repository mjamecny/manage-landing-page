...
export default function Footer() {
  ...
  return (
    <footer className="bg-veryDarkBlue py-3.2 xl:py-6.4">
      <div className="mx-auto max-w-5xl px-1.6 xl:px-[0px] grid grid-cols-1 xl:grid-cols-3 xl:grid-rows-2 gap-4.8">
        <form
          className="flex gap-0.8 xl:col-start-3"
          onSubmit={handleSubmit}
          noValidate
        >
          <div className="flex flex-col gap-0.4 md:flex-[2]">
            <input
              className={`outline-none rounded-full border ${
                error
                  ? "border-brightRed text-brightRed"
                  : "border-veryDarkBlue"
              } py-1.2 px-2.4 placeholder:text-1.4 flex-1`}
              type="email"
              name="email"
              id="email"
            ...
            />
            {error && (
              <p className="text-1.2 text-brightRed">
                Please insert a valid email
              </p>
            )}
          </div>

          <button className="uppercase rounded-full bg-brightRed text-veryLightGray h-[50px] flex-1 hover:bg-brightRed">
            Go
          </button>
        </form>
        <div className="grid grid-cols-2 xl:gap-4.8 px-1.6 xl:row-start-1 xl:row-span-2 xl:col-start-2 xl:col-span-1 xl:px-[0px]">
          <ul className="text-veryLightGray flex flex-col md:items-center xl:items-start gap-1.2">
            <li>
              <a
                className="hover:text-brightRed transition-colors duration-300"
                href="#"
              >
                Home
              </a>
        ...
        {/* TODO: change width and height of icons  */}
        <div className="flex justify-center xl:justify-start gap-2.4 xl:gap-1.2 text-veryLightGray xl:row-start-2">
          <a
            className="hover:text-brightRed transition-colors duration-300"
            href="#"
          >
        ...
        <div className="flex justify-center xl:justify-start xl:col-start-1 xl:row-start-1">
          <svg
            className="text-veryLightGray"
        ...
        <p className="text-darkGrayishBlue text-1.4 text-center xl:text-right xl:col-start-3">
